# Module 1: Infrastructure Setup and Verification

This folder contains the materials for Module 1 of Falco, which focuses on setting up and verifying the complete infrastructure stack.
...
**Note**: No models are required for Module 1 — service health check works without them.
